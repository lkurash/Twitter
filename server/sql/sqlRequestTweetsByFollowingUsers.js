...
const sqlRequestTweetsByFollowingUsers = async (
  ...
  const tweets = await db.sequelize.query(
    `SELECT "Tweets"."id", "Tweets"."text", "Tweets"."img", "Tweets"."userId", "Tweets"."retweet", "Tweets"."tweetId", "Tweets"."tweetUserId", "Tweets"."countRetweets", "Tweets"."countLikes", "Tweets"."countComments", "Tweets"."createdAt", "Tweets"."updatedAt", "likes"."id"
      ...
      LEFT OUTER JOIN "Favorite_tweets" AS "favorite_tweets" ON ("Tweets"."id" = "favorite_tweets"."tweetId" and "favorite_tweets"."userId" = ${userId})
      WHERE "user->followings_user"."userId" = ${userId} or "Tweets"."userId" = ${userId} ORDER BY "Tweets"."id"
      ${anyParams}`,
    {
...
module.exports = sqlRequestTweetsByFollowingUsers;
