...
export const PUBLIC_EXPLORE_PAGE_PATH = "/explore";
export const PUBLIC_USER_PAGE_PATH = "/user/:id/logout";
...
export const EXPLORE_PAGE_PATH = "/home/explore";
...
export const USER_PAGE_PATH = "/user/:id";
export const USER_PAGE_TWEETS_PATH = "";
export const USER_PAGE_LIKES_PATH = "/user/:id/likes";
export const USER_PAGE_ANSWERS_PATH = "/user/:id/answers";
export const USER_PAGE__MEDIA_PATH = "/user/:id/media";
export const USERS_PAGE__MEDIA_PATH = "/user/media";
export const USER_FOLLOWING_PAGE_PATH = "/user/:id/followings";
export const USER_FOLLOWER_PAGE_PATH = "/user/:id/followers";
